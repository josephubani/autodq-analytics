# ADQL 2.4 Execution Model

This document is normative for AutoDQ ADQL 2.4 runtimes.
...
not leave a partially modified table. ADQL 2.4 does not define multi-statement
