...
REQUIRED_WHEEL_FILES = {
    ...
    "autodq/operations/__init__.py",
    "autodq/operations/engine.py",
    "autodq/operations/inventory.py",
    "autodq/operations/inventory_models.py",
    "autodq/quality_tests/__init__.py",
    "autodq/quality_tests/engine.py",
    "autodq/quality_tests/models.py",
    "autodq/schema_drift/__init__.py",
    "autodq/schema_drift/engine.py",
    "autodq/schema_drift/models.py",
    ...
    "autodq/vscode/extension/review-protocol.js",
    "autodq/vscode/extension/review-renderer.mjs",
